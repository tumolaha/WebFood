        ...
        <section class="content w-full px-10 ml-20 py-5">
            ...
            <form method="POST">
                <div class="flex items-center mt-4">
                    ...
                    <input type="month" id="datepicker" name="monthPicker"
                        class="border border-gray-300 px-2 py-1 rounded" />
                    <button type="submit" name="month"
                        class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Xem</button>
                </div>
            </form>
    ...
    <div id="myModal"
        ...
        <div class="modal-content w-[550px] h-[200px] p-2">
            <div class="flex justify-end items-center">
                ...
                <span class="w-[20px] h-[20px] cursor-pointer text-white bg-red-500" class="close"
            ...
            <form method="post">
                ...
                <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                    email</label>
                <input name="danhgia" id="email"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                    placeholder="Nhập đánh giá của bạn" required>
                <div class="flex justify-center my-5">

                    <button class="w-[160px] p-1 rounded-md border-2 border-black bg-green-500 text-white "
                        type="submit" name="saveReport">Lưu</button>
                </div>
            </form>
        </div>
    </div>
