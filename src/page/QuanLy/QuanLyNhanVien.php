              ...
              $output .= '
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <form action="SuaNhanVien.php?id=' . $row['MaNV'] . '" method="post" >
                        ...
                        <button type="submit" name="edit" class="text-indigo-600 hover:text-indigo-900">Sửa</a>
                      </form>
                      <a href="#" class="ml-2 text-red-600 hover:text-red-900" onclick="deleteEmployee(' . $row['MaNV'] . ')">Xoá</a>
                    </td>
                  </tr>
                  ';
            }
