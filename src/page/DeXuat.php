        ...
        <section class="content w-full px-10 py-5">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (isset($_FILES['file_input'])) {
                    ...
                    if ($fileError === 0) {
                        if ($fileError === 0) {
                            $uploadPath = 'C:\\xampp\\htdocs\\WebFood\\src\\uploads\\' . $fileName;
            ...
            <form class="max-w-sm mx-auto" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    ...
                    <input type="manv" id="manv" name="manv"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder="Nhập mã nhân viên đề xuất" required>
                </div>
                <div class="mb-5">
                    <label for="mamon" class="block text-sm font-medium text-gray-700"> Mã món</label>
                    <input type="mamon" id="mamon" name="mamon"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder="Nhập Mã của món mới" required>
                </div>
                <div class="mb-5">
                    <label for="dongia" class="block text-sm font-medium text-gray-700"> Đơn giá</label>
                    <input type="mamon" id="dongia" name="dongia"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder="Nhập giá dự tính" required>
                </div>
                <div class="mb-5">
                    <label for="congthuc" class="block text-sm font-medium text-gray-700"> Công thức</label>
                    <input type="mamon" id="congthuc" name="congthuc"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                        placeholder="Nhập công thức làm" required>
                </div>
                <div class="mb-5">
