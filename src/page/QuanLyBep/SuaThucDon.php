...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['editThucDon'])) {
    ...
    $sql = "UPDATE menu SET MaMon = '$ma_mon', MaNL = '$ma_nguyen_lieu', NgayBan = '$ngay_ban' WHERE MaMenu = '$ma_menu'";
...
<div class="px-5 py-10">
    ...
    <form action="SuaThucDon.php" method="POST">
        ...
        <div class="mb-4">
            <label for="nagyban" class="block text-sm font-medium text-gray-700">Ngày bán</label>
